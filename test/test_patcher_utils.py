...
class TestUtils(unittest.TestCase):
    ...
    @patch("securetea.lib.auto_server_patcher.utils.get_system_name")
    ...
    @patch("securetea.lib.auto_server_patcher.utils.platform")
    ...
    @patch("securetea.lib.auto_server_patcher.utils.os")
